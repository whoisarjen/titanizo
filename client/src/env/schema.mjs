...
export const clientSchema = z.object({
    ...
    NEXT_PUBLIC_API_CACHE_TIME: z.number(),
    NEXT_PUBLIC_API_PRODUCT_PAGE_CACHE_TIME: z.number(),
...
export const clientEnv = {
    ...
    NEXT_PUBLIC_API_CACHE_TIME: Number(env.NEXT_PUBLIC_API_CACHE_TIME),
    NEXT_PUBLIC_API_PRODUCT_PAGE_CACHE_TIME: Number(env.NEXT_PUBLIC_API_PRODUCT_PAGE_CACHE_TIME),
